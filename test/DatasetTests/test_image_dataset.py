...
class TestOpenMLImageDataset(unittest.TestCase):
    ...
    def setUp(self, mock_read_image):
        ...
        mock_read_image.return_value = torch.zeros((3, self.image_size, self.image_size))
        
        # Create dataset
        self.dataset = OpenMLImageDataset(self.mock_X, self.mock_y, self.image_size, self.image_dir)
    ...
    def test_getitem_with_label(self):
        ...
        self.assertEqual(image.shape, (4, self.image_size, self.image_size))  # Image shape should be (3, H, W)
    ...
    def test_getitem_without_label(self):
        ...
        self.dataset_no_label = OpenMLImageDataset(self.mock_X, None, self.image_size, self.image_dir)
    ...
    def test_transformations(self):
        ...
        dataset_with_transform = OpenMLImageDataset(self.mock_X, self.mock_y, self.image_size, self.image_dir, transform_x=transform)
        image, label = dataset_with_transform[0]
        self.assertEqual(image.shape, (4, 128, 128))  # Image should be resized to 128x128